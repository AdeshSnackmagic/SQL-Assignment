...
select  group_concat(Distinct E.name) as Name , Min(C.Commision_amount) as Commision from Employees E join Commissions C on E.id=C.employee_id where Commision_amount>3000;
